                        ...
                        <form method="POST" action="{{ route('distributor.update', $distributor->id) }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control @error('nama_distributor') is-invalid @enderror"
                                    id="nama_distributor" type="text"
                                    value="{{ old('nama_distributor') ? old('nama_distributor') : $distributor->nama_distributor }}"
                                    placeholder="Masukan Distributor" name="nama_distributor" autocomplete="off">
