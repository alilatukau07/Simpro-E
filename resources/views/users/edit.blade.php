                        ...
                        <form method="POST" action="{{ route('users.update', $user->id) }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control @error('name') is-invalid @enderror" id="name" type="text"
                                    value="{{ old('name') ? old('name') : $user->name }}" placeholder="Nama" name="name"
                                    autocomplete="off">
                                @error('name')
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control @error('no_hp') is-invalid @enderror" id="no_hp" type="text"
                                    value="{{ old('no_hp') ? old('no_hp') : $user->no_hp }}" placeholder="No Hp"
                            ...
                            <div class="mb-3">
                                ...
                                <select name="level" class="form-control  @error('level') is-invalid @enderror"
                                    ...
                                    <option value="Admin" {{ old('level')=='Admin' ? 'selected' : '' }} {{ $user->level
                                        == 'Admin' ? 'selected' : '' }}>
                                        Admin</option>
                                    <option value="User" {{ old('level')=='User' ? 'selected' : '' }} {{ $user->level ==
                                        'User' ? 'selected' : '' }}>
                                        User</option>
                                </select>
                                @error('level')
